...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col md:flex-row items-center md:items-start justify-center p-4 md:p-8 font-sans gap-8 bg-stone-100 overflow-visible">
      
      {/* --- 左側：3D盤面エリア --- */}
      <div 
        className={`w-full max-w-[500px] aspect-square pointer-events-none md:pointer-events-auto touch-pan-y rounded-3xl shadow-2xl border-[8px] md:border-[16px] sticky top-0 md:top-8 transition-all duration-500 overflow-hidden bg-white
